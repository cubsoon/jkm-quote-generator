...
var korwa_f = [
  ...
  ', a zwykym ludziom wmawiają, że im coś "dadzą".',
  ...
  ", ale przyjdę muzułmanie i zrobią porządek.",
...
function get_quote_part(a) {
  return a[Math.floor(Math.random() * a.length)];
}

function get_quote_part_strong(a) {
  return '<span class="stronger">' + get_quote_part(a) + '</span>';
}

function get_quote() {
  return (
    get_quote_part(korwa_a) +
    get_quote_part_strong(korwa_b) +
    get_quote_part(korwa_c) +
    get_quote_part_strong(korwa_d) +
    get_quote_part(korwa_e) + 
    get_quote_part(korwa_f)
  );
}
